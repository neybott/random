...
| --- | --- | --- |
| Vereinsplaner → nuLiga | Konvertiert die Mitgliederliste von BSC 70 Linz aus CSV oder XLSX in eine nuLiga-kompatible CSV. Mitglieder lassen sich nach allen Quellfeldern filtern, mehrere Bedingungen als UND oder ODER verknüpfen und Ausgabefelder frei wählen. Filter und Feldauswahl bleiben für den nächsten Besuch gespeichert. | [Live öffnen](https://random.neyda.at/vereinsplaner2nuliga/) · [Quellcode](vereinsplaner2nuliga/index.html) · [HTML herunterladen](https://raw.githubusercontent.com/neybott/random/main/vereinsplaner2nuliga/index.html) |
